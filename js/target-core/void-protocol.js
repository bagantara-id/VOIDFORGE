 ...
 * Status: MILITARY-GRADE PATCHED (HOTFIX: Secure Handshake & History Scrubbing)
 */
...
const VoidProtocol = {
    ...
    bootSequence: async function() {
        try {
            ...
            // PERBAIKAN FATAL: Memanggil data secara individual untuk melewati blokir root Firebase
    ...
    executeVaporization: function(reason) {
        ...
        try { 
            ...
            // 2. [HISTORY SCRUBBING] Timpa URL di Address Bar menjadi URL dasar tanpa Kunci & ID 
            // Ini memastikan jika target mengecek tab "History" di browser, kuncinya sudah lenyap.
